...
export const checkUserInDB = async(id)=>{
    ...
    try {
        ...
        if(UserInDB == null){
            return {message:"This user is not in the system."}
        }
...
export const addUser = async(previousState,formData)=>{
    const {username,email,firstname,lastname,password,passwordRepeat,isAdmin} = Object.fromEntries(formData);
    ...
    try {
        ...
        const newUser = await axios.post(`${path}/api/User/AddUser`,{
            username,
            firstname,
            lastname,
            email,
...
export const editUser = async(previousState,formData)=>{
    const{userId,newUsername,newEmail,newFirstname,newLastname,newPassword,newIsAdmin,checkPassword} = Object.fromEntries(formData);
