"use client";
import { GetimportDetail, GetiExcelDetail } from '../../../../../../function/listSubject'
...
const SubjectDetailPage = ({ params }) => {
    ...
    const [importH, setImportH] = useState({});
    const [loading, setLoading] = useState(false);

    const fetchData = async () => {
        await setLoading(true);
        try {
            const importHeaderDetail = await GetimportDetail(id);
            const excelHeaderDetail = await GetiExcelDetail(id);

            await setListItem(excelHeaderDetail);
            await setImportH(importHeaderDetail);
        } catch (error) {
            console.error(error);
        } finally {
