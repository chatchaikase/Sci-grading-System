...
import { CountListimportheader, getAllListSubject, getListimportheaderForPage } from "../../../function/listSubject";
import Pagination from "../../../components/Pageination/Pageination"
export default async function ImportListPage({searchParams}) {
  const page = searchParams?.page || 1;
  const list = await getListimportheaderForPage(page);
  const countPage = await CountListimportheader(); 
